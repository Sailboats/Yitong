package com.yitong.slidingmenu;
...
public class SlidingActivityHelper {
	...
	private SlidingMenu mSlidingMenu;//一个布局（MainActivity中initSlidingMenu()方法getSlidingMenu()返回的就是它
	                                   //具体的样子可参照mSlidingMenumain.xml的展示
