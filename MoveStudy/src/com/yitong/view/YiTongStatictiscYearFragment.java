 ...
 * 
 * */
public class YiTongStatictiscYearFragment extends Fragment {
	private Context context;
	private PieChart mPieChart;
	private PieData mPieData;
	View mView;

	public YiTongStatictiscYearFragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mView = (View) inflater.inflate(R.layout.yitong_statistics_fragment,
				container, false);
		return mView;
	}
	...
	private void initView() {
		mPieChart = (PieChart) mView
				.findViewById(R.id.yitong_statistics_piechart);
	}
	...
	private PieData getPieData(int count, float range) {
		...
		PieDataSet pieDataSet = new PieDataSet(yValues,
				"Quarterly Revenue 2015"); /* 显示在比例图上 */
    ...
    * */
	private void showChart(PieChart pieChart, PieData pieData) {
		...
		pieChart.setDescription("yitong统计表");
